        ...
        <form action="" ref="form">
            <div class="form-application" v-if="!applicationForm">
                <div class="row">
                    ...
                    <div class="col col--6 col-bt--4 col-s--2 col-xs--2">
                        <div class="form-application__data">
            ...
            <transition name="fade" mode="in-out">
                <div class="block__history"  v-if="applicationForm">
                    <div class="application-form">
                        <h3>{{responseMessage.title}}</h3>
                        <v-button text="Return to the page" link="/" @click.native="mainPage"></v-button>
                    </div>
                </div>
